...
<section class="hero">
    <div class="container">
      ...
      <ol class="breadcrumb justify-content-center">
        ...
        <li class="breadcrumb-item active">Une marque</li>
      </ol>
      <!-- Hero Content-->
      ...
      <div class="row">
        ...
        <div class="product col-xl-3 col-lg-4 col-sm-6">
          ...
          <div class="py-2">
            ...
            <h3 class="h6 text-uppercase mb-1"><a href="<?=$router->generate('catalog_product', ['product_id'=> $currentProduct->getId()])?>" class="text-dark"><?= $currentProduct->getName()?></a></h3><span class="text-muted"><?= $currentProduct->getPrice()?>€</span>
          </div>
        </div>
        <?php endforeach ?>
          <?php }else {?>

          <h1>Il n'y a pas de produit de cette marque</h1> 

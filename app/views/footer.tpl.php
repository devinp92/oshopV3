            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <?php foreach ($viewVars['allFooterTypes'] as $typeModel): ?>

                            <li> <a href="<?= $router->generate('catalog_type', ['type_id' => $typeModel->getId()]); ?>" class="text-muted"><?= $typeModel->getName(); ?></a></li>
                ...
                <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <?php foreach ($viewVars['allFooterBrands'] as $brandModel): ?>

                            <li> <a href="<?= $router->generate('catalog_brand', ['brand_id' => $brandModel->getId()]); ?>" class="text-muted"><?= $brandModel->getName(); ?></a></li>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <ul class="list-inline mb-0 mt-2 mt-md-0 text-center text-md-right">
                        <li class="list-inline-item">
                            <img src="<?=$viewVars['baseUri']?>/assets/images/visa.svg" alt="..." class="payment-icon">
                        </li>
                        <li class="list-inline-item">
                            <img src="<?=$viewVars['baseUri']?>/assets/images/mastercard.svg" alt="..." class="payment-icon">
                        </li>
                        <li class="list-inline-item">
                            <img src="<?=$viewVars['baseUri']?>/assets/images/paypal.svg" alt="..." class="payment-icon">
                        </li>
                    </ul>
                </div>
            </div>

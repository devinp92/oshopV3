...
|created_at|DATETIME|NOT NULL, DEFAULT CURRENT_TIMESTAMP|La date de création du produit|
|updated_at|DATETIME|NULL|La date de la dernière mise à jour du produit|
|brand|entity|NOT NULL|La marque (autre entité) du produit|
|category|entity|NULL|La catégorie (autre entité) du produit|
|type|entity|NOT NULL|Le typee (autre entité) du produit|
...
|created_at|DATETIME|DEFAULT CURRENT_TIMESTAMP|La date de création de la catégorie|
|updated_at|DATETIME|NULL|La date de la dernière mise à jour de la catégorie|
...
|created_at|DATETIME|DEFAULT CURRENT_TIMESTAMP|La date de création de la marque|
|updated_at|DATETIME|NULL|La date de la dernière mise à jour de la marque|
